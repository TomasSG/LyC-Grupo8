...
F:\MinGW\bin\gcc.exe  ./lib/lista_ts.c ./lib/lista_tercetos.c ./lib/pila.c ./lib/lexico.c ./lib/semantico.c ./lib/gci.c ./lib/assembler.c ./lex.yy.c ./y.tab.c -o ./Segunda.exe
pause
cls
