...
programa	: bloque {printf(" Inicia COMPILADOR\n");} programa
		| bloque
		;
...
bloqueIf	: IF PAR_ABIERTO condicion PAR_CERRADO LLAVE_ABIERTO bloque LLAVE_CERRADO
		...
		| IF PAR_ABIERTO condicion PAR_CERRADO LLAVE_ABIERTO bloque LLAVE_CERRADO ELSE LLAVE_ABIERTO bloque LLAVE_CERRADO 
		| IF PAR_ABIERTO condicion PAR_CERRADO sentencia ELSE LLAVE_ABIERTO bloque LLAVE_CERRADO
		| IF PAR_ABIERTO condicion PAR_CERRADO LLAVE_ABIERTO bloque LLAVE_CERRADO ELSE sentencia
		| IF PAR_ABIERTO condicion PAR_CERRADO sentencia ELSE sentencia
		;
