...
typedef int(*t_cmp)(const t_dato_lista_tercetos*,const t_dato_lista_tercetos*);
...
int insertar_ordenado_tercetos(t_lista_tercetos*,const t_dato_lista_tercetos*,t_cmp);
